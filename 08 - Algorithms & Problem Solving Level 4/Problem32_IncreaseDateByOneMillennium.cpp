...
sDate IncreseDateByOneDecade(sDate Years) {
	Years = IncreseDateByNYears(Years, 10);
    return Years;
}

sDate IncreseDateByNDecade(sDate date, short decades) {
	date = IncreseDateByNYears(date, decades * 10);
	return date;
}

sDate IncreseDateByOneCentury(sDate date) {
	date = IncreseDateByNYears(date, 100);


	return date;
}

sDate IncreseDateByOneMillennium(sDate date) {
	date = IncreseDateByNDecade(date, 100);
	return date;
}
int main()
{
	...
	cout << "The date after one decade is: " << date.Day << "/" << date.Month << "/" << date.Year << endl;
	date = IncreseDateByNDecade(date, 10);
	cout << "The date after 10 decades is: " << date.Day << "/" << date.Month << "/" << date.Year << endl;
	date = IncreseDateByOneCentury(date);
	cout << "The date after one century is: " << date.Day << "/" << date.Month << "/" << date.Year << endl;
	date = IncreseDateByOneMillennium(date);
	cout << "The date after one millennium is: " << date.Day << "/" << date.Month << "/" << date.Year << endl;
