...
int main()
{
	...
	if (IslastDayInMonth(date)) {
		cout << "This is the last day in the month." << endl;

	}
	else {
		cout << "This is not the last day in the month." << endl;
	}
	if (IslastMonth(date)) {
		cout << "This is the last month of the year." << endl;
	}
	else {
		cout << "This is not the last month of the year." << endl;
	}
